            ...
            <div className="flex justify-center items-center">
                <div className="flex justify-center items-center gap-5 flex-wrap w-[80%]">
                    ...
                    <div className="flex flex-col w-[15%] max-md:w-full">
                        <span className="text-sm font-semibold text-[#111111] mb-3">Icons</span>
                        <ul className="space-y-6 text-xs mt-3 text-[#757575]">
                            <li>
                                <Link
                                    href="#"
                    ...
                    <div className="flex flex-col w-[18%] max-md:w-full">
                        <span className="text-sm font-semibold text-[#111111] mb-3">Shoes</span>
                        <ul className="space-y-6 text-xs mt-3 text-[#757575]">
                            <li>
                                <Link
                                    href="#"
                    ...
                    {/* Clothing Section */}
                    <div className="flex flex-col w-[18%] max-md:w-full">
                        <span className="text-sm font-semibold text-[#111111] mb-3">Clothing</span>
                        <ul className="space-y-6 text-xs mt-3 text-[#757575]">
                            <li>
                                <Link
                                    href="#"
                    ...
                    <div className="flex flex-col w-[33%] max-md:w-full">
                        <span className="text-sm font-semibold text-[#111111] mb-3">Kid&apos;s</span>
                        <ul className="space-y-6 text-xs mt-3 text-[#757575]">
                            <li>
                                <Link
                                    href="#"
